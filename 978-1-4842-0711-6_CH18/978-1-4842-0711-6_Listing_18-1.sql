...
(
	CustomerID		INT		NOT NULL	IDENTITY PRIMARY KEY NONCLUSTERED HASH WITH(BUCKET_COUNT = 20000),
	FirstName		VARCHAR(30)	NOT NULL,
	LastName		VARCHAR(30)	NOT NULL,
	BillingAddressID	INT		NOT NULL,
	DeliveryAddressID	INT		NOT NULL,
...
--Set LOCK_ECALATION to AUTO

ALTER TABLE dbo.Customers SET (LOCK_ESCALATION = AUTO) ;

--Set WAIT_AT_LOW_PRIORITY

ALTER INDEX idx_LastName ON dbo.Customers REBUILD WITH (ONLINE = ON (WAIT_AT_LOW_PRIORITY (MAX_DURATION = 1 MINUTES, ABORT_AFTER_WAIT = BLOCKERS))) ;
